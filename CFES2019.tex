...
\begin{refsection}
	\begin{itemize}
		...
		\item Budget \cite{moore_fy19_2018-1}
	\end{itemize}
	\printbibliography[heading=none]
\end{refsection}

\subsection{DOI-OIA Biological Control of Coconut Rhinoceros Beetle Biotype-G in Micronesia 2Y \$????K}
\begin{refsection}
	\printbibliography
\end{refsection}
...
\subsection{McIntire-Stennis Guam Forest Insect Survey 5Y \$????K}
\begin{refsection}
	\begin{itemize}
...
\subsection{USDA-APHIS-2020 Biological Control of Coconut Rhinoceros Beetle Biotype-G 1Y \$?????}
